...
Before changing code, identify the target crate/module and trace its callers,
feature propagation, route ownership, auth middleware, and focused tests. Treat
Axum paths, OPDS 1.2/2.0, KOReader, Kobo, Komga/Grimmory, liseur-sync,
GraphQL/mobile API, SQLite/SeaORM schema, media streaming, and generated SDK
types as compatibility-sensitive.
...
gate and reports exact evidence.
