...
pub const DEFAULT_ATTACHMENT_MAX_BYTES: usize = 8 * 1024 * 1024; // 8 MiB
...
pub const DEFAULT_INGEST_PREPROCESS_TIMEOUT_SECS: u64 = 600; // 10 minutes
...
pub const DEFAULT_ENABLE_MAM_ACQUISITION: bool = false;
