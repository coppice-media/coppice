...
the SeaORM adapter and scan-job orchestration stay in the core integration
layer (`core/src/filesystem/scanner/{library_scan_job.rs,series_scan_job.rs,store.rs,utils.rs}`); media building and writes remain in core services. The modular scan implementation itself is this crate.
...
| Reference                                                                                                                    | Pin                                                                                             | Notes                                                                                                                                    |
| ---------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| Current modular implementation                                                                                               | `crates/scanner/src/{walk.rs,options.rs,tag_cache.rs}`                                          | The scanner implementation and its public planning primitives live here; `stump_core` supplies the persistence adapter and job boundary. |
| Historical upstream baseline                                                                                                 | `stumpapp/stump` nightly merge `37fdb7d7` (PR #1361)                                            | Behavioural baseline before extraction; the old walkers accepted `Ctx`/database state directly.                                          |
| Extraction                                                                                                                   | `27764cf5` (crate created), `3cebf0b8` (core files deleted, `store.rs` adapter added)           | `git log --oneline -- crates/scanner`; the current adapter remains in core while traversal stays here.                                   |
