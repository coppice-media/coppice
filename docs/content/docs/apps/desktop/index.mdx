...
- **Standalone**: No need to open a browser to use Coppice
- **Discord Rich Presence**: Show off what you're doing in Coppice to your friends
- **Bundled Server**: Run your Coppice server from the app itself, so you don't need to configure one separately
- **Multiple Instances**: Connect to as many Coppice instances as you want
