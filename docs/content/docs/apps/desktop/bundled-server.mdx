...
The desktop app comes with a fully functional Coppice server built-in. This is a convenience feature to make it easier to get started with Coppice without needing to set up a server separately.
