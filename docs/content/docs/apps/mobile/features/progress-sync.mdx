...
The mobile app supports progression sync for **Coppice servers only**.
...
Progression sync is only supported for Coppice servers. There are some other limitations to be aware of:
