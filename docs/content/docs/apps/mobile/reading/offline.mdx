...
Coppice has file associations for the supported formats, so you can use your device's file browser to find a book and open it with Coppice. This will import the book into the app and make it available for offline reading.
