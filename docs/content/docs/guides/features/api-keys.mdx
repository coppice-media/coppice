...
You can authorize a request to your Coppice instance by including the key value in the `Authorization` header of your requests. The header should look like this:

```
Authorization: Bearer <your_api_key>
```

If you're using the Coppice SDK (`@stump/sdk`), you can set it directly when you create the SDK instance:
...
const sdk = new Api({
	baseURL: 'https://my-coppice.cloud',
	authMethod: 'api-key',
	apiKey: '<your_api_key>',
})
